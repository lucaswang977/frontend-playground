...
export const TodoTaskList = (props: TaskListProps) => {
  ...
  const getClassName = (task: TodoTask) => {
    let classArr = [styles.li];

    if (modifyItem) classArr.push(styles.visuallyDisabled);
    classArr.push(task === dragItem ? styles.dragging : styles.notDragging);
  ...
  return (
    <div className="task-list">
      <div
        ...
        className={modifyItem ? styles.inputMask : [styles.inputMask, styles.visuallyHidden].join(" ")}
      ></div>
      <ul>
